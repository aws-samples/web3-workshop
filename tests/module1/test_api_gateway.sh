...
# curl -X POST -H 'Accept: application/json' -H "Authorization: Bearer ${jwt}" -d '{"prompt":"this is my first sentence NFT"}' ${API_GATEWAY_ENDPOINT}/tokens/sentences
...
curl -X GET -H 'Accept: application/json' -H "Authorization: Bearer ${jwt}" ${API_GATEWAY_ENDPOINT}/tokens/sentences